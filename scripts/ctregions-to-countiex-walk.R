...
#Select "planning regions" as source geography and "counties" as target geography
css <- c(
  '#inputOptions > div:nth-child(4) > p > select > optgroup:nth-child(7) > option:nth-child(2)',
  '#inputOptions > div:nth-child(5) > p > select > optgroup:nth-child(3) > option:nth-child(1)'
)
...
write.csv(geocorr, "ctregions2counties.csv", row.names = FALSE, na = "")
